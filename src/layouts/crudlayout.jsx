...
const  CrudLayout = ({from}) =>{
    
    return (
        <>
        <div className="dark:bg-zinc-900 ">
        <Header backto={from}/>
        <div className="grid gird-cols-1 md:grid-cols-7 gap-4 pt-20">
...
const Header = ({backto})=>{
    return (<>
    <header className="fixed shadow-md top-0 left-0 right-0 z-10  bg-green-800 p-4 text-white">
